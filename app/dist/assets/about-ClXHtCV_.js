import{q as c,R as o,o as e,v as s,I as a,N as p,c as n,a as l}from"./index-D0jUTnUe.js";const r=new c({snapshotIsolation:!0,template(){return o({className:"px-[20vw] py-[20vh]",onmount(){document.querySelector("[data-wrapper]").dataset.snapshot==="true"&&alert("rendered from snapshot")}},e("Cradova",{className:"text-[5rem] mb-[1.2rem]"}),s("What is Cradova?",{className:"text-[2rem]"}),a(`What is Cradova?
...
`),s("Contribution and License Agreement",{className:"text-[2rem] mt-[2rem]"}),a("If you contribute code to this project, you are implicitly allowing your code to be distributed under same license. You are also implicitly verifying that all code is your original work."),p({href:"https://github.com/Uiedbook/cradova",className:"w-fit px-4 py-6 rounded-[999px] m-auto bg-[rebeccapurple] mt-[2rem]"},n("find more about cradova 💓",{className:"text-[#fff] text-[1.7rem]"})))}});export{r as aboutPage};
